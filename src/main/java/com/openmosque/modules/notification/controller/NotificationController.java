...
@Tag(name = "User Notifications & Alerts", description = "Endpoints for managing worshipper notifications and Iqamah change alerts")
public class NotificationController {
    ...
    public ResponseEntity<ApiResponse<NotificationResponseDto>> markAsRead(
        ...
        NotificationResponseDto response = notificationService.markAsRead(id, user);
